...
class yolodeep:
    ...
    def initialize():
        ...
        self.model = self.create_model(self.input_shape, self.anchors, self.num_classes,
    ...
    def learn(self,batchSize):
        ...
        if True:
            ...
            self.batch_size = batchSize # note that more GPU memory is required after unfreezing the body
            print('Train on {} samples, val on {} samples, with batch size {}.'.format(self.num_train, self.num_val, self.batch_size))
